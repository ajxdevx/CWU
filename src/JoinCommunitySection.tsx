...
export default function JoinCommunitySection() {
  return (
    <section
      className="box-border flex w-full min-w-0 shrink-0 flex-col justify-center bg-[#F7F5F0] py-4 min-[480px]:min-h-[580px] min-[480px]:py-0"
    ...
    >
      ...
      */}
      <div className="mx-auto flex w-full max-w-[613px] flex-col items-center px-6 py-12 text-center @container sm:px-8 sm:py-14">
        <h2
        ...
        <p className="mt-6 w-full text-balance font-['DM_Sans',sans-serif] text-[17px] font-normal leading-[1.35] tracking-normal text-[#777777] sm:mt-8 sm:text-[20px] md:mt-10 md:text-[24px]">
