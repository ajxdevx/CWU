export default function HeroLaunchLine() {
  return (
    <div className="hero-intro-launch relative left-0 mt-0 flex min-h-0 w-full max-w-full shrink-0 items-center justify-center gap-2.5 rounded-none sm:gap-3 min-[1260px]:mt-28 min-[1260px]:h-[24px] min-[1260px]:w-[385px] min-[1260px]:max-w-none min-[1260px]:justify-start">
      <span
        className="mt-px h-2 w-2 shrink-0 rounded-full bg-[#3CDAC4] sm:mt-0"
        aria-hidden={true}
      />
