...
export default function CoinVisual() {
  return (
    <div className="flex w-full origin-center scale-[1.06375] justify-center">
      <svg
        width={710}
        height={628}
        viewBox="0 0 715 655"
        ...
        role="img"
        aria-hidden={true}
        className="hero-intro-coin block h-auto w-full max-w-[min(100%,min(620px,86vw))] shrink-0 rounded-none max-h-[min(30dvh,268px)] max-[1659px]:max-w-[78vw] min-[1660px]:max-h-[min(548px,calc(100dvh-260px))] min-[1660px]:w-[min(620px,38vw)] min-[1660px]:max-w-[min(620px,40vw)]"
