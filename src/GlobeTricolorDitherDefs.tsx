...
/** Site blues (#014778 / #2073A8 / #72C8FF), normalized 0–1 for feComponentTransfer. */
...
/**
 * Hidden SVG defs: ordered-dither + 3-level posterization to brand blues (feComponentTransfer).
 * Commonwealth globe video only.
 */
