...
export default function LearnMoreButton({ compactPair = false }: LearnMoreButtonProps) {
  return (
    <button
      ...
      className={
        compactPair
          ? 'inline-flex min-h-[56px] min-w-0 flex-1 basis-0 items-center justify-center rounded-[14.19px] border-[1.42px] border-solid border-[rgba(255,255,255,0.15)] bg-transparent px-3 py-4 text-center transition-[border-color,opacity] hover:border-[rgba(255,255,255,0.28)] hover:opacity-95 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#3CDAC4] max-[1274px]:py-5 sm:max-[1274px]:w-full sm:max-[1274px]:flex-none sm:max-[1274px]:basis-auto sm:max-[1274px]:px-4 min-[1275px]:h-auto min-[1275px]:min-h-0 min-[1275px]:w-fit min-[1275px]:shrink-0 min-[1275px]:flex-none min-[1275px]:basis-auto min-[1275px]:py-4 min-[1275px]:min-[400px]:px-6 min-[1275px]:min-[400px]:py-5 min-[1275px]:sm:px-8 min-[1275px]:px-10'
